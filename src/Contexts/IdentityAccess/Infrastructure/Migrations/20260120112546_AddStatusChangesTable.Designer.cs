...
namespace Ecliptix.IdentityAccess.Infrastructure.Migrations
{
    ...
    [Migration("20260120112546_AddStatusChangesTable")]
    partial class AddStatusChangesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.AccountPinAuthEntity", b =>
                {
                    ...
                    b.ToTable("account_pin_auth", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.AccountSecureKeyAuthEntity", b =>
                {
                    ...
                    b.ToTable("account_secure_key_auth", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.DeviceContextEntity", b =>
                {
                    ...
                    b.ToTable("device_contexts", null, t =>
                        {
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.FailedOtpAttemptEntity", b =>
                {
                    ...
                    b.Property<long>("OtpCodeId")
                        .HasColumnType("bigint")
                        .HasColumnName("otp_code_id");
                    ...
                    b.ToTable("failed_otp_attempts", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.LoginAttemptEntity", b =>
                {
                    ...
                    b.HasIndex("MembershipId", "Outcome", "AttemptedAt")
                    ...
                    b.ToTable("login_attempts", null, t =>
                        {
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.LogoutAuditEntity", b =>
                {
                    ...
                    b.HasIndex("MembershipId", "LoggedOutAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_LogoutAudits_Membership_LoggedOutAt")
                        .HasFilter("is_deleted = false");

                    b.ToTable("logout_audits", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.MasterKeyShareEntity", b =>
                {
                    ...
                    b.HasIndex("AccountId", "ShareIndex")
                        .IsUnique()
                        .HasDatabaseName("UQ_MasterKeyShares_AccountShare");

                    b.ToTable("master_key_shares", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.MobileNumberEntity", b =>
                {
                    ...
                    b.ToTable("mobile_numbers", (string)null);
                });
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.StatusChangeEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasIndex("UniqueId")
                        .IsUnique()
                        .HasDatabaseName("UQ_StatusChangeEntity_UniqueId");

                    b.HasIndex("EntityType", "EntityId", "ChangedAt")
                        .IsDescending(false, false, true)
                        .HasDatabaseName("IX_StatusChanges_Entity_ChangedAt");

                    b.HasIndex("EntityType", "PropertyName", "ToValue", "ChangedAt")
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.VerificationFlowEntity", b =>
                {
                    ...
                    b.ToTable("verification_flows", null, t =>
                        {
            ...
            modelBuilder.Entity("Ecliptix.IdentityAccess.Domain.Schema.Entities.FailedOtpAttemptEntity", b =>
                {
                    b.HasOne("Ecliptix.IdentityAccess.Domain.Schema.Entities.OtpCodeEntity", "OtpCode")
