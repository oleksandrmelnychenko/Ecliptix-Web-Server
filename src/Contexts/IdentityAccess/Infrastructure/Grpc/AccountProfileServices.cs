...
namespace Ecliptix.IdentityAccess.Infrastructure.Grpc;

public sealed class AccountProfileServices : AccountServices.AccountServicesBase
{
    private readonly GrpcSecurityService _service;
    private readonly IActorRef _accountActor;
    private readonly SecurityConfiguration _securityConfig;

    public AccountProfileServices(
    ...
    public override async Task<SecureEnvelope> CheckProfileNameAvailability(SecureEnvelope request, ServerCallContext context)
    {
    ...
    public override async Task<SecureEnvelope> CreateOrUpdateProfile(SecureEnvelope request, ServerCallContext context)
    {
