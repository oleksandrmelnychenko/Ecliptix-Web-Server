using Ecliptix.IdentityAccess.Domain.Schema.Configurations;
using Ecliptix.IdentityAccess.Domain.Schema.Entities;
using Ecliptix.IdentityAccess.Domain.Schema.Interceptors;
...
public class EcliptixSchemaContext : DbContext
{
    ...
    public DbSet<StatusChangeEntity> StatusChanges { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.AddConfiguration(new StatusChangeConfiguration());
    }
