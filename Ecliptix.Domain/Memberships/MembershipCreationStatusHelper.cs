...
public static class MembershipCreationStatusHelper
{
    ...
    {
        if (ReverseCreationStatusMap.TryGetValue(status, out string? statusString))
        {
            return statusString;
        }
    ...
    public static Membership.Types.CreationStatus GetCreationStatusEnum(string statusString)
    {
        ...
        if (CreationStatusMap.TryGetValue(statusString, out Membership.Types.CreationStatus status))
        {
            return status;
        }
