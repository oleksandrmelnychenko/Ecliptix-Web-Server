...
BEGIN TRY
    ...
    ('OTP.ExpirationMinutes', '0.5', 'int', 'OTP expiration time in minutes', 'Security'),
    ...
    INSERT INTO dbo.SystemConfiguration (ConfigKey, ConfigValue, DataType, Description, Category) VALUES
    ('VerificationFlow.DefaultExpirationMinutes', '1', 'int', 'Default verification flow expiration in minutes', 'Security');
