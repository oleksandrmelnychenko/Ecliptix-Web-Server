...
namespace Ecliptix.Domain.Migrations
{
    ...
    [Migration("20251202095358_InitialPostgreSQL")]
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.AccountSecureKeyAuthEntity", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("AccountId"), new[] { "UniqueId", "SecureKey", "MaskingKey", "CredentialsVersion", "IsPrimary" });
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.LoginAttemptEntity", b =>
                {
                    ...
                    b.HasIndex("DeviceId", "AttemptedAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_LoginAttempts_Device")
                        .HasFilter("[IsDeleted] = 0 AND [DeviceId] IS NOT NULL");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("DeviceId", "AttemptedAt"), new[] { "IsSuccess" });
                    ...
                    b.HasIndex("MobileNumber", "LockedUntil", "AttemptedAt")
                        ...
                        .HasDatabaseName("IX_LoginAttempts_Lockout_Covering")
                        .HasFilter("[IsDeleted] = 0 AND [LockedUntil] IS NOT NULL");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("MobileNumber", "LockedUntil", "AttemptedAt"), new[] { "Id", "Outcome", "ErrorMessage" });
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.MembershipEntity", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("MobileNumberId"), new[] { "UniqueId", "CreationStatus" });
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.MembershipRelationEntity", b =>
                {
                    ...
                    b.HasIndex("InitiatorAccountId", "RecipientAccountId")
                        .HasDatabaseName("IX_MembershipRelations_InitiatorRecipient_Covering")
                        .HasFilter("[IsDeleted] = 0");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("InitiatorAccountId", "RecipientAccountId"), new[] { "Status", "Message", "CreatedAt", "MutedUntil" });

                    b.HasIndex("RecipientAccountId", "InitiatorAccountId")
                        .HasDatabaseName("IX_MembershipRelations_RecipientInitiator_Covering")
                        .HasFilter("[IsDeleted] = 0");

                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("RecipientAccountId", "InitiatorAccountId"), new[] { "Status", "Message", "CreatedAt", "MutedUntil" });
