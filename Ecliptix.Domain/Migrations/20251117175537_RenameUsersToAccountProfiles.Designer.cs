...
namespace Ecliptix.Domain.Migrations
{
    ...
    [Migration("20251117175537_RenameUsersToAccountProfiles")]
    partial class RenameUsersToAccountProfiles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.AccountPinAuthEntity", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_AccountPinAuthEntity_CreatedAt")
                        .HasFilter("IsDeleted = 0");
                    ...
                    b.HasIndex("UpdatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_AccountPinAuthEntity_UpdatedAt")
                        .HasFilter("IsDeleted = 0");
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.AccountProfileEntity", b =>
                {
                    ...
                    b.HasIndex("ProfileName")
                        .IsUnique()
                        .HasDatabaseName("IX_AccountProfiles_ProfileName_Unique")
                        .HasFilter("[IsDeleted] = 0");
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.AccountSecureKeyAuthEntity", b =>
                {
                    ...
                    b.HasIndex("CreatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_AccountSecureKeyAuthEntity_CreatedAt")
                        .HasFilter("IsDeleted = 0");
                    ...
                    b.HasIndex("UpdatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_AccountSecureKeyAuthEntity_UpdatedAt")
                        .HasFilter("IsDeleted = 0");
            ...
            modelBuilder.Entity("Ecliptix.Domain.Schema.Entities.VerificationLogEntity", b =>
                {
                    ...
                    b.HasIndex("UpdatedAt")
                        .IsDescending()
                        .HasDatabaseName("IX_VerificationLogEntity_UpdatedAt")
                        .HasFilter("IsDeleted = 0");
